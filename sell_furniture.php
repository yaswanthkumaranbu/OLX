...
<nav> 
    ...
    <form action="sell_insert.php" method="post">
        ...
        <input type="text" id="name" name="item_name" placeholder="Enter your furniture name (ex:sofa)" required><br><br>

        <label for="description1">Description 1:</label>
        <textarea id="description1" name="item_description1" placeholder="(Condition : Good)"></textarea><br><br>

        <label for="description2">Description 2:</label>
        <textarea id="description2" name="item_description2"  placeholder="(Used : 2 Years)"></textarea><br><br>

        <label for="price">Price:</label>
        <input type="text" id="price" name="item_price" required  placeholder="(20 K)"><br><br>

        <label for="image_url">Image URL:</label>
        <input type="text" id="image_url" name="item_image" required  placeholder="(Furniture/sofa.jpg)"><br><br>
